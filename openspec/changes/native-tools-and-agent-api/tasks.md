## 1. Implementación
- [x] 1.1 Sincronizar catálogo nativo y retirar su CRUD público, conservando asociaciones y selección por agente.
- [x] 1.2 Ampliar scopes de API keys para prompts/agentes y asignación de canal desactivado; preservar autorización y aislamiento.
