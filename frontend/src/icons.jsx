const paths = {
  ...
  whatsapp: 'M20.5 11.5a8.5 8.5 0 0 1-12.7 7.4L3 20.5l1.6-4.8a8.5 8.5 0 1 1 15.9-4.2Z M8.2 7.3l1.6 2.9-1.1 1.1c.8 1.6 1.9 2.7 3.6 3.5l1.1-1.1 2.9 1.6c-.5 1.5-1.2 1.9-2.5 1.5-4.1-1.3-6.5-3.7-7.2-7.1-.2-1 .3-1.8 1.6-2.4Z',
...
export const channelIcon = (kind) => ['instagram', 'whatsapp', 'email'].includes(kind) ? kind : 'channels';
